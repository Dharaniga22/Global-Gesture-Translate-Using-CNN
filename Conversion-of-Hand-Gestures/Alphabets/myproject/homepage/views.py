...
def test(request):
	classifier = load_model('D:/Musthafa/Stud_Projects/2024/Conversion-of-Hand-Gestures/Alphabets/myproject/homepage/Trained_model.h5')
#classifier.evaluate()

#Prediction of single image

	#img_name = input('Enter Image Name:')
	image_path = 'D:/Musthafa/Stud_Projects/2024/Conversion-of-Hand-Gestures/Alphabets/myproject'+request.POST['url']
